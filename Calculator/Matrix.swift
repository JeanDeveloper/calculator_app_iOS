...
struct Matrix{
    static let firstSectionData: [KeyboardButton] = [
        .init(title: "AC", textColor: .black, backgroundColor: customLightGray, isDoubleWidth: false, type: .clear),
        .init(title: "+/-", textColor: .black, backgroundColor: customLightGray, isDoubleWidth: false, type: .clear),
        .init(title: "%", textColor: .black, backgroundColor: customLightGray, isDoubleWidth: false, type: .clear),
    ...
    static let secondSectionData: [KeyboardButton] = [
        ...
        .init(title: ",", textColor: .white, backgroundColor: customDarkGray, isDoubleWidth: false, type: .clear),
        .init(title: "=", textColor: .white, backgroundColor: customOrange, isDoubleWidth: false, type: .equal)
    ]
